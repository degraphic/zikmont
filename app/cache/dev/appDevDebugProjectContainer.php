...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/var/www/zikmont/app/cache/dev/annotations', true);
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/var/www/zikmont/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FrameworkBundle', '/var/www/zikmont/app/Resources/FrameworkBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FrameworkBundle', '/var/www/zikmont/vendor/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SecurityBundle', '/var/www/zikmont/app/Resources/SecurityBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SecurityBundle', '/var/www/zikmont/vendor/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'TwigBundle', '/var/www/zikmont/app/Resources/TwigBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'TwigBundle', '/var/www/zikmont/vendor/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MonologBundle', '/var/www/zikmont/app/Resources/MonologBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MonologBundle', '/var/www/zikmont/vendor/symfony/src/Symfony/Bundle/MonologBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SwiftmailerBundle', '/var/www/zikmont/app/Resources/SwiftmailerBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SwiftmailerBundle', '/var/www/zikmont/vendor/symfony/src/Symfony/Bundle/SwiftmailerBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'DoctrineBundle', '/var/www/zikmont/app/Resources/DoctrineBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'DoctrineBundle', '/var/www/zikmont/vendor/symfony/src/Symfony/Bundle/DoctrineBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AsseticBundle', '/var/www/zikmont/app/Resources/AsseticBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AsseticBundle', '/var/www/zikmont/vendor/bundles/Symfony/Bundle/AsseticBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SensioFrameworkExtraBundle', '/var/www/zikmont/app/Resources/SensioFrameworkExtraBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SensioFrameworkExtraBundle', '/var/www/zikmont/vendor/bundles/Sensio/Bundle/FrameworkExtraBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'JMSSecurityExtraBundle', '/var/www/zikmont/app/Resources/JMSSecurityExtraBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'JMSSecurityExtraBundle', '/var/www/zikmont/vendor/bundles/JMS/SecurityExtraBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'zikmontFrontEndBundle', '/var/www/zikmont/app/Resources/zikmontFrontEndBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'zikmontFrontEndBundle', '/var/www/zikmont/src/zikmont/FrontEndBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'YepsuaSmarTwigBundle', '/var/www/zikmont/app/Resources/YepsuaSmarTwigBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'YepsuaSmarTwigBundle', '/var/www/zikmont/vendor/bundles/Yepsua/SmarTwigBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'mensajeszkMensajesBundle', '/var/www/zikmont/app/Resources/mensajeszkMensajesBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'mensajeszkMensajesBundle', '/var/www/zikmont/src/mensajeszk/MensajesBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'impresionesImpresionesBundle', '/var/www/zikmont/app/Resources/impresionesImpresionesBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'impresionesImpresionesBundle', '/var/www/zikmont/src/impresiones/ImpresionesBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'carteraGestionBundle', '/var/www/zikmont/app/Resources/carteraGestionBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'carteraGestionBundle', '/var/www/zikmont/src/cartera/GestionBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'autenticacionLoginBundle', '/var/www/zikmont/app/Resources/autenticacionLoginBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'autenticacionLoginBundle', '/var/www/zikmont/src/autenticacion/LoginBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeDemoBundle', '/var/www/zikmont/app/Resources/AcmeDemoBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'AcmeDemoBundle', '/var/www/zikmont/src/Acme/DemoBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'WebProfilerBundle', '/var/www/zikmont/app/Resources/WebProfilerBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'WebProfilerBundle', '/var/www/zikmont/vendor/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SensioDistributionBundle', '/var/www/zikmont/app/Resources/SensioDistributionBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SensioDistributionBundle', '/var/www/zikmont/vendor/bundles/Sensio/Bundle/DistributionBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SensioGeneratorBundle', '/var/www/zikmont/app/Resources/SensioGeneratorBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'SensioGeneratorBundle', '/var/www/zikmont/vendor/bundles/Sensio/Bundle/GeneratorBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, '', '/var/www/zikmont/app/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/var/www/zikmont/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'bdzikmont', 'host' => '201.232.85.215', 'port' => '3306', 'user' => 'kasten', 'password' => 'aba70143086.', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $a, $b, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_b77bfba72e1137afc680d4fa8f873e15');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_b77bfba72e1137afc680d4fa8f873e15');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_b77bfba72e1137afc680d4fa8f873e15');

        $e = new \Symfony\Bridge\Doctrine\Annotations\IndexedReader($a);

        $f = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($e, array(0 => '/var/www/zikmont/src/zikmont/FrontEndBundle/Entity', 1 => '/var/www/zikmont/src/cartera/GestionBundle/Entity'));

        $g = new \Symfony\Bridge\Doctrine\Mapping\Driver\YamlDriver(array(0 => '/var/www/zikmont/src/autenticacion/LoginBundle/Resources/config/doctrine'));
        $g->setNamespacePrefixes(array('/var/www/zikmont/src/autenticacion/LoginBundle/Resources/config/doctrine' => 'autenticacion\\LoginBundle\\Entity'));
        $g->setGlobalBasename('mapping');

        $h = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $h->addDriver($f, 'zikmont\\FrontEndBundle\\Entity');
        $h->addDriver($f, 'cartera\\GestionBundle\\Entity');
        $h->addDriver($g, 'autenticacion\\LoginBundle\\Entity');

        $i = new \Doctrine\ORM\Configuration();
        $i->setEntityNamespaces(array('zikmontFrontEndBundle' => 'zikmont\\FrontEndBundle\\Entity', 'carteraGestionBundle' => 'cartera\\GestionBundle\\Entity', 'autenticacionLoginBundle' => 'autenticacion\\LoginBundle\\Entity'));
        $i->setMetadataCacheImpl($b);
        $i->setQueryCacheImpl($c);
        $i->setResultCacheImpl($d);
        $i->setMetadataDriverImpl($h);
        $i->setProxyDir('/var/www/zikmont/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/var/www/zikmont/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/var/www/zikmont/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\SqliteProfilerStorage('sqlite:/var/www/zikmont/app/cache/dev/profiler.db', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/var/www/zikmont/app/config/routing_dev.yml', array('cache_dir' => '/var/www/zikmont/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appdevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appdevUrlMatcher'));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/var/www/zikmont/app');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/var/www/zikmont/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => 'php', 'translation.loader.yml' => 'yml', 'translation.loader.xliff' => 'xliff'), array('cache_dir' => '/var/www/zikmont/app/cache/dev/translations', 'debug' => true), $this->get('session'));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => '/var/www/zikmont/app/cache/dev/twig', 'charset' => 'UTF-8'));
        ...
        $instance->addExtension($this->get('twig.extension.jquery.ui.core'));
        $instance->addExtension($this->get('twig.extension.jquery.ui.addons'));
        $instance->addExtension($this->get('twig.extension.js.sintax'));
        $instance->addExtension($this->get('twig.extension.jquery.core'));
        $instance->addExtension($this->get('twig.extension.html.tags'));
    ...
    /**
     * Gets the 'twig.extension.html.tags' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Yepsua\SmarTwigBundle\Twig\Extension\HTMLExtension A Yepsua\SmarTwigBundle\Twig\Extension\HTMLExtension instance.
     */
    protected function getTwig_Extension_Html_TagsService()
    {
        return $this->services['twig.extension.html.tags'] = new \Yepsua\SmarTwigBundle\Twig\Extension\HTMLExtension();
    }

    /**
     * Gets the 'twig.extension.jquery.core' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Yepsua\SmarTwigBundle\Twig\Extension\JQueryCoreExtension A Yepsua\SmarTwigBundle\Twig\Extension\JQueryCoreExtension instance.
     */
    protected function getTwig_Extension_Jquery_CoreService()
    {
        return $this->services['twig.extension.jquery.core'] = new \Yepsua\SmarTwigBundle\Twig\Extension\JQueryCoreExtension();
    }

    /**
     * Gets the 'twig.extension.jquery.ui.addons' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Yepsua\SmarTwigBundle\Twig\Extension\UIAddonsExtension A Yepsua\SmarTwigBundle\Twig\Extension\UIAddonsExtension instance.
     */
    protected function getTwig_Extension_Jquery_Ui_AddonsService()
    {
        $this->services['twig.extension.jquery.ui.addons'] = $instance = new \Yepsua\SmarTwigBundle\Twig\Extension\UIAddonsExtension();

        $instance->setBuilders(array('ui.block' => 'YsBlockUI', 'ui.box' => 'YsJQBox', 'ui.colorpicker' => 'YsJQColorPicker', 'ui.notify' => 'YsPNotify', 'ui.hotkey' => 'YsKeys', 'ui.monitor' => 'YsJQMonitor', 'ui.keypad' => 'YsJQKeypad', 'ui.calculator' => 'YsJQCalculator', 'ui.layout' => 'YsJLayout', 'ui.mask' => 'YsJQMask', 'ui.formWizard' => 'YsFormWizard', 'ui.ajaxForm' => 'YsJQForm', 'ui.validation' => 'YsJQValidate', 'ui.booklet' => 'YsJQBooklet', 'ui.cycle' => 'YsJQCycle', 'ui.ring' => 'YsJQRing'));

        return $instance;
    }

    /**
     * Gets the 'twig.extension.jquery.ui.core' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Yepsua\SmarTwigBundle\Twig\Extension\UICoreExtension A Yepsua\SmarTwigBundle\Twig\Extension\UICoreExtension instance.
     */
    protected function getTwig_Extension_Jquery_Ui_CoreService()
    {
        $this->services['twig.extension.jquery.ui.core'] = $instance = new \Yepsua\SmarTwigBundle\Twig\Extension\UICoreExtension();

        $instance->setBuilders(array('ui.html' => 'YsHTML', 'ui.jqueryCore' => 'YsJQuery', 'ui.dialog' => 'YsUIDialog', 'ui.tabs' => 'YsUITabs', 'ui.accordion' => 'YsUIAccordion', 'ui.progressbar' => 'YsUIProgressbar', 'ui.slider' => 'YsUISlider', 'ui.autocomplete' => 'YsUIAutocomplete', 'ui.datepicker' => 'YsUIDatepicker', 'ui.datetimepicker' => 'YsUIDateTimepicker', 'ui.button' => 'YsUIButton', 'ui.multiselect' => 'YsUIMultiSelect', 'ui.picklist' => 'YsUIPickList', 'ui.popup' => 'YsUIPopUp', 'ui.selectmenu' => 'YsUISelectMenu', 'ui.expander' => 'YsUIExpander', 'ui.splitter' => 'YsUISplitter', 'ui.dynaselect' => 'YsUIDynamicSelect', 'ui.menu' => 'YsUIMenu', 'ui.panel' => 'YsUIPanel', 'ui.tooltip' => 'YsUITooltip', 'ui.draggable' => 'YsUIDraggable', 'ui.droppable' => 'YsUIDroppable', 'ui.resizable' => 'YsUIResizable', 'ui.effect' => 'YsUIEffect'));

        return $instance;
    }

    /**
     * Gets the 'twig.extension.js.sintax' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Yepsua\SmarTwigBundle\Twig\Extension\JsSintaxExtension A Yepsua\SmarTwigBundle\Twig\Extension\JsSintaxExtension instance.
     */
    protected function getTwig_Extension_Js_SintaxService()
    {
        return $this->services['twig.extension.js.sintax'] = new \Yepsua\SmarTwigBundle\Twig\Extension\JsSintaxExtension();
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/zikmont/vendor/symfony/src/Symfony/Bundle/TwigBundle/DependencyInjection/../../../Bridge/Twig/Resources/views/Form');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, new \Symfony\Component\DependencyInjection\ParameterBag\ParameterBag($this->getDefaultParameters()), '/var/www/zikmont/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/var/www/zikmont/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/var/www/zikmont/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/var/www/zikmont/vendor/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array(0 => '/var/www/zikmont/src/zikmont/FrontEndBundle/Resources/config/validation.yml')))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/var/www/zikmont/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/var/www/zikmont/app/cache/dev',
            'kernel.logs_dir' => '/var/www/zikmont/app/logs',
            'kernel.bundles' => array(
                ...
                'zikmontFrontEndBundle' => 'zikmont\\FrontEndBundle\\zikmontFrontEndBundle',
                'YepsuaSmarTwigBundle' => 'Yepsua\\SmarTwigBundle\\YepsuaSmarTwigBundle',
                'mensajeszkMensajesBundle' => 'mensajeszk\\MensajesBundle\\mensajeszkMensajesBundle',
                'impresionesImpresionesBundle' => 'impresiones\\ImpresionesBundle\\impresionesImpresionesBundle',
                'carteraGestionBundle' => 'cartera\\GestionBundle\\carteraGestionBundle',
                'autenticacionLoginBundle' => 'autenticacion\\LoginBundle\\autenticacionLoginBundle',
            ...
            'database_host' => '201.232.85.215',
            'database_port' => '3306',
            'database_name' => 'bdzikmont',
            'database_user' => 'kasten',
            'database_password' => 'aba70143086.',
            ...
            'debug.container.dump' => '/var/www/zikmont/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/var/www/zikmont/vendor/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            'validator.mapping.loader.yaml_files_loader.mapping_files' => array(
                0 => '/var/www/zikmont/src/zikmont/FrontEndBundle/Resources/config/validation.yml',
            ),
            ...
            'profiler.storage.dsn' => 'sqlite:/var/www/zikmont/app/cache/dev/profiler.db',
            ...
            'router.resource' => '/var/www/zikmont/app/config/routing_dev.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/var/www/zikmont/app/cache/dev/twig',
                'charset' => 'UTF-8',
            ),
            ...
            'doctrine.orm.proxy_dir' => '/var/www/zikmont/app/cache/dev/doctrine/orm/Proxies',
            ...
            'assetic.cache_dir' => '/var/www/zikmont/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/var/www/zikmont/app/../web',
            'assetic.write_to' => '/var/www/zikmont/app/../web',
            ...
            'html.builder.class' => 'YsHTML',
            'jquery.core.builder.class' => 'YsJQuery',
            'jquery.ui.dialog.class' => 'YsUIDialog',
            'jquery.ui.tabs.class' => 'YsUITabs',
            'jquery.ui.accordion.class' => 'YsUIAccordion',
            'jquery.ui.progressbar.class' => 'YsUIProgressbar',
            'jquery.ui.slider.class' => 'YsUISlider',
            'jquery.ui.autocomplete.class' => 'YsUIAutocomplete',
            'jquery.ui.datepicker.class' => 'YsUIDatepicker',
            'jquery.ui.datetimepicker.class' => 'YsUIDateTimepicker',
            'jquery.ui.button.class' => 'YsUIButton',
            'jquery.ui.multiselect.class' => 'YsUIMultiSelect',
            'jquery.ui.picklist.class' => 'YsUIPickList',
            'jquery.ui.popup.class' => 'YsUIPopUp',
            'jquery.ui.selectmenu.class' => 'YsUISelectMenu',
            'jquery.ui.expander.class' => 'YsUIExpander',
            'jquery.ui.splitter.class' => 'YsUISplitter',
            'jquery.ui.dynaselect.class' => 'YsUIDynamicSelect',
            'jquery.ui.menu.class' => 'YsUIMenu',
            'jquery.ui.panel.class' => 'YsUIPanel',
            'jquery.ui.tooltip.class' => 'YsUITooltip',
            'jquery.ui.draggable.class' => 'YsUIDraggable',
            'jquery.ui.droppable.class' => 'YsUIDroppable',
            'jquery.ui.resizable.class' => 'YsUIResizable',
            'jquery.ui.effect.class' => 'YsUIEffect',
            'jquery.ui.blockui.class' => 'YsBlockUI',
            'jquery.ui.box.class' => 'YsJQBox',
            'jquery.ui.colorpicker.class' => 'YsJQColorPicker',
            'jquery.ui.notify.class' => 'YsPNotify',
            'jquery.ui.keys.class' => 'YsKeys',
            'jquery.ui.monitor.class' => 'YsJQMonitor',
            'jquery.ui.keypad.class' => 'YsJQKeypad',
            'jquery.ui.calculator.class' => 'YsJQCalculator',
            'jquery.ui.layout.class' => 'YsJLayout',
            'jquery.ui.mask.class' => 'YsJQMask',
            'jquery.ui.formwizard.class' => 'YsFormWizard',
            'jquery.ui.ajaxform.class' => 'YsJQForm',
            'jquery.ui.validation.class' => 'YsJQValidate',
            'jquery.ui.booklet.class' => 'YsJQBooklet',
            'jquery.ui.cycle.class' => 'YsJQCycle',
            'jquery.ui.ring.class' => 'YsJQRing',
