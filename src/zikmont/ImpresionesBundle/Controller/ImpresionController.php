...
use PDF\Lib\fpdf\src\Fpdf_Fpdf;
...
class ImpresionController extends Controller {
    ...
    public function getTipoDocumento()
    {
        ...
        $arDocumento =  $em->getRepository('zikmontInventarioBundle:InvDocumentos')->findBy();
    }
    ...
    public function setNombreDocumento($codigoDocumento)
    {
...
//        $this->NombreDocumento = $arDocumento->getNombreDocumento();
        $this->NombreDocumento = "Solicitud";
    }
    
    public function  setAbreviatura()
    {
    }
    
    public function Generar($arDetalles) {

        $codigoDocumento = $arDetalles[0]->getMovimientoRel()->getCodigoDocumentoFk();
        $pdf = new \Fpdf_Fpdf();
        
//        $this->setDetallesMovimiento($arDetalles);
//        $this->setNombreDocumento($codigoDocumento);
//
//        $pdf = new Fpdf_Fpdf();
//        $this->Pdf->AliasNbPages();
//        $this->Pdf->AddPage();
//        $this->Pdf->SetTitle($this->NombreDocumento);
//        $this->Header();
//        $this->Body();
//        $this->Pdf->Output("$this->NombreDocumento.pdf", 'D');
    }
