...
class CtbMovimientosResumen
{
     ...
     * Set cuentaRel
     *
     * @param zikmont\ContabilidadBundle\Entity\CuentasContables $cuentaRel
     */
    public function setCuentaRel(\zikmont\ContabilidadBundle\Entity\CuentasContables $cuentaRel)
    {
     ...
     * Get cuentaRel
     *
     * @return zikmont\ContabilidadBundle\Entity\CuentasContables 
     */
     ...
     *
     * @param zikmont\ContabilidadBundle\Entity\CierresMesContabilidad $ciereMesContabilidadRel
     */
    public function setCiereMesContabilidadRel(\zikmont\ContabilidadBundle\Entity\CierresMesContabilidad $ciereMesContabilidadRel)
    {
     ...
     *
     * @return zikmont\ContabilidadBundle\Entity\CierresMesContabilidad 
     */
