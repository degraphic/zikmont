 ...
 * @ORM\Entity(repositoryClass="zikmont\ContabilidadBundle\Repository\CtbControlRetencionesRepository")
 */
class CtbControlRetenciones
{
    ...
    private $fechaUltimoComentario;
     ...
     /**
     * @ORM\ManyToOne(targetEntity="zikmont\SeguridadBundle\Entity\User", inversedBy="CtbControlRetenciones")
     ...
     *
     * @param zikmont\SeguridadBundle\Entity\User $usuarioRecibeRel
     */
    public function setUsuarioRecibeRel(\zikmont\SeguridadBundle\Entity\User $usuarioRecibeRel)
    {
