 ...
 * @ORM\Entity(repositoryClass="zikmont\ContabilidadBundle\Repository\CtbControlRetencionesComentariosRepository")
 */
class CtbControlRetencionesComentarios
{
    ...
    protected $ctbControlRetencionesRel;      
     ...
     /**
     * @ORM\ManyToOne(targetEntity="zikmont\SeguridadBundle\Entity\User", inversedBy="CtbControlRetencionesComentarios")
     ...
     *
     * @param zikmont\ContabilidadBundle\Entity\CtbControlRetenciones $ctbControlRetencionesRel
     */
    public function setCtbControlRetencionesRel(\zikmont\ContabilidadBundle\Entity\CtbControlRetenciones $ctbControlRetencionesRel)
    {
     ...
     *
     * @return zikmont\ContabilidadBundle\Entity\CtbControlRetenciones 
     */
     ...
     * Set usuarioRel
     *
     * @param zikmont\SeguridadBundle\Entity\User $usuarioRel
     */
    public function setUsuarioRel(\zikmont\SeguridadBundle\Entity\User $usuarioRel)
    {
     ...
     * Get usuarioRel
     *
     * @return zikmont\SeguridadBundle\Entity\User 
     */
