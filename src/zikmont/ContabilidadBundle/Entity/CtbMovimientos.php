 ...
 * @ORM\Entity(repositoryClass="zikmont\ContabilidadBundle\Repository\CtbMovimientosRepository")
 */
class CtbMovimientos
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="CtbCuentasContables", inversedBy="CtbMovimientos")
     * @ORM\JoinColumn(name="codigo_cuenta_fk", referencedColumnName="codigo_cuenta_pk")
     */
    protected $cuentaRel;       
  
    /**
     * @ORM\ManyToOne(targetEntity="CtbCentrosCostos", inversedBy="CtbMovimientos")
